...
public class tugas2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        grupsuhu.add(rcelcius);
        rcelcius.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        grupsuhu.add(rfahrenheit);
        rfahrenheit.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        grupsuhu.add(rreamur);
        rreamur.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        grupsuhu.add(rkelvin);
        rkelvin.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        txtfahrenheit.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtfahrenheit, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(10, 10, 10)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(txtreamur, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(txtkelvin, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(36, 36, 36))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtcelcius, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(txtkelvin, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(txtreamur, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void rcelciusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rcelciusActionPerformed
        ...
        if (rcelcius.isSelected()){ 
            c = Float.parseFloat(txtinput.getText());
            cel=c; rea=(c*4)/5; far=((c*9)/5)+32; kel=(c+273);    
        }
    ...
    private void rfahrenheitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rfahrenheitActionPerformed
        ...
        if (rfahrenheit.isSelected()){
            f = Float.parseFloat(txtinput.getText());
            cel=((f-32)*5)/9; rea=((f-32)*4)/9; kel=(((f-32)*5)/9)+273; far=f;
        }
    ...
    private void rreamurActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rreamurActionPerformed
        ...
        if (rreamur.isSelected()){ 
            r = Float.parseFloat(txtinput.getText());
            cel=(r*5)/4; far=((r*9)/4)+32; kel=((r*5)/4)+273; rea=r;
        }
    ...
    private void rkelvinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rkelvinActionPerformed
        ...
        if (rkelvin.isSelected()){ 
            k = Float.parseFloat(txtinput.getText());
            cel=k-273; rea=((k-273)*4)/5; far=(((k-273)*9)/5)+32; kel=k;
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        txtreamur.setText(Float.toString(rea));
